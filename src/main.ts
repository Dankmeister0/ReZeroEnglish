			...
			.add("ul").open()
				.add("li").open()
					.addRef(dropdownRef).set("onchange", onFilter).open()
						...
						.add("option").set("textContent", "Arc 8")
						.add("option").set("textContent", "Arc 7")
						.add("option").set("textContent", "Arc 6")
						.add("option").set("textContent", "Arc 5")
						.add("option").set("textContent", "Arc 4")
						.add("option").set("textContent", "Arc 3")
						.add("option").set("textContent", "Arc 2")
						.add("option").set("textContent", "Arc 1")
						.add("option").set("textContent", "One Day")
